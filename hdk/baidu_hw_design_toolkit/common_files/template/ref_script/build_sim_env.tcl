...
set_property used_in_simulation false [get_files $projGUIDir/${projName}.srcs/sources_1/ip/pr_region_dbg_bridge/pr_region_dbg_bridge.xci]
...
if {($USE_DDR4_C0 == 1) || ($USE_DDR4_C1 == 1) || ($USE_DDR4_C2 == 1) || ($USE_DDR4_C3 == 1)} {
   set_property used_in_simulation false [get_files $projGUIDir/${projName}.srcs/sources_1/bd/rp_mig_bd/rp_mig_bd.bd]

...
# define dbg_perf(fmt, ...) pr_debug("%s():" fmt, __func__, ##__VA_ARGS__)
# define dbg_sg(fmt, ...) pr_debug("%s():" fmt, __func__, ##__VA_ARGS__)
# define dbg_irq(fmt, ...) pr_debug("%s():" fmt, __func__, ##__VA_ARGS__)
# define dbg_init(fmt, ...) pr_debug("%s():" fmt, __func__, ##__VA_ARGS__)
# define dbg_tfr(fmt, ...) pr_debug("%s(): %s%c: " fmt, __func__,      \
...
struct xdma_dev {
    ...
    struct xdma_char *xvc_char_dev;
    struct xil_xvc_char xvc_char;
